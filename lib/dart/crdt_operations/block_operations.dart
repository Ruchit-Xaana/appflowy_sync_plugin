...
class BlockOperations {
  ...
  static Future<void> updateNode(BlockActionDoc action, MapCrdt crdt) async {
    ...
    if (action.block.delta != null) {
      ...
      debugPrintCustom('Current text: "$currentText"');
      debugPrintCustom('New delta (diff): $newDeltaJson');
      ...
      debugPrintCustom('Current delta: $currentDeltaJson');
      ...
      debugPrintCustom('Composed delta: $composedDeltaJson');
      blockData[_text] = await DeltaOperations.applyDeltaToText(
        currentText,
        newDeltaJson,
      );
      blockData[_delta] = composedDeltaJson;
      debugPrintCustom('Updated text: "${blockData[_text]}"');
      debugPrintCustom('=== COMPOSITION COMPLETE ===');
    }
    debugPrintCustom('Updated block data: $blockData');
